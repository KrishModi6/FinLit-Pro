  ...
  return (
    <>
      ...
      <TryIt moduleId={moduleId} placeholder="Company A: P/E ___, EPS ___ · Company B: P/E ___, EPS ___ · What the gap might mean: …">
        ...
        <p>Then write one sentence on what the gap might mean. Not what you would buy — what the difference in multiple suggests the market believes about each company’s future. If the P/Es are nearly identical, say that, and say what would have to change for them to diverge.</p>
      </TryIt>
