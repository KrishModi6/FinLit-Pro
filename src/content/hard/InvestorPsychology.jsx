...
export default function InvestorPsychology({ moduleId }) {
  return (
    <>
      ...
      <p>The quiet damage is to <Term k="position sizing">position sizing</Term>. Suppose you set a sensible limit of 5% of your portfolio per idea. You buy at $80 at exactly 5%. It falls by half, so the position is now around 2.6% of a portfolio that has also shrunk a bit. You add the same dollar amount again and you are back near 5%, but with double the shares, and a thesis that is weaker than it was on day one. Do it twice more and a single deteriorating idea is your largest holding. Nobody makes that decision consciously. It arrives one reasonable-sounding step at a time.</p>
